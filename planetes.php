...
<div class="container">
    <div class="row">
        ...
        {
            $lien = "info_planetes.php?ID=".$data["id"];
            ?>

            <div class="mx-auto" style="padding-top: 50px">
                <div class="card mb-3" style="width: 300px; height: 400px">
                    <div class="card-body">
                        <a href="<?php echo $lien;?>"><h4 style="text-align: center; padding-bottom: 20px" class="card-title"  ><?php echo $data["nom"]; ?></h4></a>
                        <p style="text-align:center;"><img src="<?php echo $data["image"]?>"width="250px" height="250px"></p>
